<?php 
	...
	if($_POST['action']=='Delete'){
			...
			mysql_query($query);
			 //echo $query."<br>";
			$query="DELETE FROM `tbl_news_and_act`  WHERE  `id` =  '".$_POST['IDS']."' ";
			mysql_query($query);	
			// echo $query."<br>";		 
		}
	...
	####################################################	
	   if($_POST['cate_id']!=''){
				...
				$query="SELECT * FROM   `tbl_news_and_act` WHERE  `cate_id` ='".$_POST['cate_id']."'  ORDER BY date_act DESC";
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="txt10-black">
      ...
      <tr>
        ...
        <td align="center" bgcolor="#EFEFEF"><a href="main.php?work=ActivityAdd&currID=<?PHP echo $data['id']?>"><img src="images/black_icon/16x16/doc_edit.png" width="16" height="16" style="border:none" /></a></td>
