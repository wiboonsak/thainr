...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong> B.RIGHT RUBBER CO.,LTD. </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td>29, 31 Chotivithayakul 3 Road, T.Hatyai, Hatyai, Songkhla 90110</td>
        </tr>
        <tr>
          <td height="25" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">(074) 429966 (Hunting line)</p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="25"></td>
          <td ><p align="left">(074) 429110, 429111, 429971</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><A href="mailto:niyomrubber@hotmail.com">marketing@b-rightrubber.com</A></p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td ><p>Mr. San Phanphipat (Assistant Managing Director)<br>
          Mr. Ng Cheng Eng (General Manager)<br>
Mrs. Mali Phanphiphat (Finance Manager) <br>
Mr. Juti Phanphiphat (Assistant Managing Director) <br>
           </p>            </td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        ...
        <tr>
          ...
          <td height="19"></td>
          <td valign="middle"><p align="left">RSS (18,000 MT/Month)</p></td>
        </tr>
