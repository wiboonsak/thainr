...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><STRONG>Rubber Research Institute of Thailand (RRIT)</STRONG></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          <td width="150" height="25"><div align="right"><strong>Address</strong></div></td>
          <td height="25"></td>
          <td><p>Department of Agriculture, Chatuchak Bangkok 10900 Thailand</p></td>
        </tr>
        <tr>
          <td height="34" bgcolor="#EAEAEA"><p align="right"><strong>Tel </strong></p></td>
          <td height="34" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">662 5797557-8, 5793667, 5791576</p></td>
        </tr>
        <tr>
          <td height="24"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="24"></td>
          <td ><p align="left">662 5614744, 5790585</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-mai</strong>l</p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><a href="mailto:rrit@doa.go.th">rrit@doa.go.th</a>, <a href="mailto:pranipat@doa.go.th">pranipat@doa.go.th</a></p></td>
        </tr>
        <tr>
          <td height="24"><p align="right"><strong>Website</strong></p></td>
          <td height="24"></td>
          <td ><p align="left"><a href="http://www.rrit.doa.go.th/">www.rrit.doa.go.th</a></p></td>
        </tr>
        <tr>
