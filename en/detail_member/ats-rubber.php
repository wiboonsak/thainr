...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>A.T.S. RUBBER CO.,LTD. </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p>99 Moo 6,T.Nabon, A.Nabon, Nakornsritammaraj 80220 </p></td>
        </tr>
        <tr>
          <td height="34" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></td>
          <td height="34" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">(075) 491660-3</p></td>
        </tr>
        <tr>
          <td height="24"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="24"></td>
          <td ><p align="left">(075) 491659 </p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><A href="mailto:prapase@hotmail.com">prapase@hotmail.com</A>,<A href="mailto:Tuenweradej89@hotmail.com">Tuenweradej89@hotmail.com</A></p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td ><p align="left">Mr.Prapas Euanontat </p></td>
        </tr>
        <tr>
          <td height="25"><p align="right">&nbsp;</p></td>
          <td height="25"></td>
          <td ><p align="left">Mr.Amorn Tuenweradaj (Managing Director) </p></td>
        </tr>
        ...
        <tr>
          ...
          <td height="21"></td>
          <td valign="middle"><p>RSS (3,000 MT/Month)</p></td>
        </tr>
