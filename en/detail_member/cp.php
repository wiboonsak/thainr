...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>C.P. INTERTRADE CO.,LTD. </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p><span lang="TH">89</span>&nbsp;AIA CAPITAL CENTER,&nbsp;<span lang="TH">28</span>th Fl., Ratchadapisek Rd., Dindaeng, Bangkok&nbsp;<span lang="TH">10400</span></p></td>
        </tr>
        <tr>
          <td height="25" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></td>
          <td height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">(02) 646 7353</p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="25"></td>
          <td ><p align="left">(02) 646 – 7026, 646 - 7109</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></td>
          <td height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><A href="mailto:thitiplun.vec@cptrading.co.th">thitiplun.vec@cptrading.co.th</A></p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Website </strong></p></td>
          <td height="25"></td>
          <td ><p align="left">www.cpthairice.com</p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td ><p>Mr.Sumeth Laomoraporn <br>
          Mr.Vivat Ausavanop </p>            </td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td height="25"></td>
          <td><p>Mrs. Thitiplun Vechprasit</p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          <td height="32" valign="top"><p align="right"><strong>Products/Capacity </strong></p></td>
          <td width="10" height="32"></td>
          <td valign="middle"><p>Trading</p></td>
        </tr>
        <tr>
