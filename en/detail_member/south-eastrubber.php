...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>SOUTH-EAST RUBBER  CO.,LTD. </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td ><p>Mr. Terdsak Leepairojkul (Managing Director) </p>
            </td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p>Mr. Terdsak Leepairojkul</p>
            </td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        ...
        <tr>
          ...
          <td height="21"></td>
          <td valign="middle"><p>RSS  3-5   (1,500 MT/Month)</p></td>
        </tr>
        <tr>
