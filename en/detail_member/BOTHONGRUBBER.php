...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>BOTHONG RUBBER FUND COOPERATIVE LTD.</strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p>341 Moo 1, Tambol Bothong, Amphor Bothong, Chonburi 20270</p></td>
        </tr>
        <tr>
          <td height="34" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></td>
          <td height="34" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">66 86 3929282, 66 38 211188 ext.15</p></td>
        </tr>
        <tr>
          <td height="24"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="24"></td>
          <td ><p align="left">66 38-211188 ext.51</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><a href="mailto:marketing@btrubbercoop.or.th" target="_blank">marketing@btrubbercoop.or.th</a>, <a href="mailto:orose1991@gmail.com" target="_blank">orose1991@gmail.com </a></p></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p>Ms. Raweeploy Yutthacharoenkit</p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
