  ...
  <table width="242" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr align="left" valign="top">
      ...
      <td width="228" align="center" bgcolor="#FFFFFF"><table width="90%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="#"><img src="../th/images/link-synthetic.gif" alt="Activity" width="205" height="48" vspace="5" border="0" /></a></td>
        </tr>
        <tr>
          <td><a href="#"><img src="../th/images/link-offerprice.gif" alt="Activity" width="205" height="48" vspace="5" border="0" /></a></td>
        </tr>
        <tr>
          <td><a href="#"><img src="../th/images/link-bidding.gif" alt="Activity" width="205" height="48" vspace="5" border="0" /></a></td>
        </tr>
        <tr>
          <td><a href="#"><img src="../th/images/link-local.gif" alt="Activity" width="205" height="48" vspace="5" border="0" /></a><a href="?detail=ac-calendar"></a></td>
        </tr>
        <tr>
          <td><a href="#"><img src="../th/images/link-cess.gif" alt="Activity" width="205" height="67" vspace="5" border="0" /></a></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        </tr>
