...
<div class="style1"><?php 						
  ...
  <tr>
    <td width="231" height="24" align="left" ><img src="../th/images/inside/nr_26.jpg" alt="thainr" width="231" height="24" /></td>
    <td width="100%"align="right" valign="top" background="../th/images/inside/bg-bot-talk.gif" class="FontMS10"><?php GetOnlyEngMonth($speech['date_post'])?><?php if($speech['date_end']!='0000-00-00'){ echo "&nbsp&nbsp-&nbsp;";GetOnlyEngMonth($speech['date_end']); } ?>    
   &nbsp;&nbsp;&nbsp;&nbsp; </td>
  </tr>
</table>
</center>