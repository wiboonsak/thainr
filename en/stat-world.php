    ...
    <tr>
      ...
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" background="../images/h-title/h-message_bg.gif"><img src="../images/h-title/h-world-statistic.jpg" alt="history" width="341" height="100" /></td>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="72" height="22" bgcolor="#FFFFFF">&nbsp;</td>
            <td width="720" height="22" align="left" valign="top" bgcolor="#FFFFFF" class="FontMS10 bottom-dot"><span class="FontMS10"><img src="../th/images/report-chart.gif" alt="chart" width="16" height="16"></span>
            <!--<a href="#" onClick="windowOpener(850, 1000, 'windowName', 'detail-stat.php?statID=<?php //echo $stat['id']?>')">--> <a href="http://www.thainr.com/uploadfile/<?php echo $stat['file_th']?>" target="_blank"><?php echo $stat['title_en']?> </a>
              <?php $icon="<img src=../th/images/3_43.gif  hspace=3 />";  $day =$stat['date_post']; GetNewIcon($day,$icon)?>
            </td>
            <td width="26" height="22" align="right" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
          <?php } ?>
          <tr>
          ...
          <tr>
            <td height="126" bgcolor="#F8F8F8">&nbsp;</td>
            <td align="center" bgcolor="#F8F8F8" class="FontMS10">&nbsp;</td>
