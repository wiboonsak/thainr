  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D7EFF9">
    ...
    <tr>
      ...
      <td align="center" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="142" background="images/inside/bg-tab.gif"><img src="images/inside/nr_over_29.jpg" alt="กิจกรรมการประชุม" width="142" height="35"  border="0" ></td>
              ...
              <tr>
				...
				if($pic['file_name']==''){
                    ...
                    <tr>
                      ...
                      <td align="left" valign="top" style="padding-top:5px; padding-bottom:5px; padding-left:10px; padding-right:5px;">&nbsp;</td>
                      <td align="center">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="104" align="center">&nbsp;</td>
                      <td width="136"><a href="#" onClick="windowOpener(700, 1000, 'windowName', 'detail-activity.php?ActID=<?php echo $data['id']?>')">
                       <img src="<?php echo $pic['file_name']?>" width="125" height="83" style="vertical-align:middle; border:none;"  class="radius5" /></a></td>
                      <td width="599" align="left" valign="top" style="padding:10px;"><span style="padding-top:5px; padding-bottom:5px; padding-left:10px; padding-right:5px;"><img src="../images/icon/24X24/105.png" alt="webboard" width="24" height="24" style="vertical-align:text-bottom"></span><a href="#" onClick="windowOpener(700, 1000, 'windowName', 'detail-activity.php?ActID=<?php echo $data['id']?>')" id="news"><strong><?php echo $data['topic_th'];?></strong><br>
                      </a>
                      <?php if(($n==1)&&($page==1)){ ?>
