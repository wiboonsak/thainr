...
<link href="style.css" rel="stylesheet" type="text/css" />
  <table width="242" border="0" cellpadding="0" cellspacing="0">
    <tr align="left" valign="top">
      <td colspan="3"><img src="images/inside/h-l-stat.gif" width=242 height=54 alt=""></td>
    </tr>
    <tr align="left" valign="top">
      ...
      <td width="228" align="center" bgcolor="#FFFFFF"><table width="90%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><a href="?detail=stat-thai"><img src="images/link-th-stat.gif" alt="Activity" width="205" height="48" vspace="5" border="0" /></a></td>
        </tr>
        <tr>
          <td><a href="?detail=stat-world"><img src="images/link-world-stat.gif" alt="Activity" width="205" height="48" vspace="5" border="0" /></a></td>
        </tr>
        <tr>
          <td><a href="?detail=stat-other"><img src="images/link-other-stat.gif" alt="Activity" width="205" height="48" vspace="5" border="0" /></a><a href="?detail=ac-calendar"></a></td>
        </tr>
