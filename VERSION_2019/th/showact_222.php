<?php
	  //$query="SELECT  *  FROM `tbl_news_and_act` WHERE cate_id = '$cateID'  AND language='$lang' ORDER  BY   date_act  DESC  LIMIT 0 , 5 ";
		$query="SELECT  *  FROM `tbl_news_and_act` WHERE  language = '$lang' ORDER  BY   date_act  DESC  LIMIT 0 , 5 ";
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="779">&nbsp;</td>
    <td width="150" align="right"><span class="txt8"><img src="../images/icon/30x30/002.png" width="30" height="30" alt="icon" style="vertical-align: text-bottom" /></span><a href="?detail=ac-meeting&amp;cateID=<?php echo $cateID?>">กิจกรรมสมาคมฯ ทั้งหมด</a>&nbsp;&nbsp;</td>
  </tr>
  <tr>
