<?php
	$query="SELECT  *  FROM `tbl_news_data`  WHERE cate_id ='1' AND language='$lang'   ORDER BY  date_act  DESC  LIMIT 0 , 10 ";
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="779">&nbsp;</td>
    <td width="150" align="right"><a href="?detail=news-rubber&xtype=1">ข่าวสารทั้งหมด</a></td>
  </tr>
