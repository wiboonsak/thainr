...
<table width="242" border="0" cellspacing="0" cellpadding="0" class="FontMS10">
  <tr align="left" valign="top"> 
    <td width="7"><IMG SRC="images/inside/nr_05.jpg" WIDTH=7 HEIGHT=54 ALT=""></td>
    <td width="228" bgcolor="#FFFFFF"><IMG SRC="images/inside/nr_06.jpg" WIDTH=228 HEIGHT=54 ALT=""></td>
    <td width="7"><IMG SRC="images/inside/nr_07.jpg" WIDTH=7 HEIGHT=54 ALT=""></td>
  </tr>
  <tr align="left" valign="top"> 
    <td><IMG SRC="images/inside/nr_09.jpg" WIDTH=7 HEIGHT=193 ALT=""></td>
	  ...
	  ?>
       <!-- <tr>
          ...
          <td width="140" align="left" class="text-news"><?php //if($data['event_title']){?>
			  ...
			  <?php //echo substr($data['event_title'],0,50)?><?php //echo $data['event_title']?>... </a>
        ...
        <tr>
          ...
          <td align="left" class="text-news"><?php if($dataList['cal_header']){?>
              <a href="#"  onclick="OpenNew('detail-calendar.php?keyID=<?php echo $dataList['id'];?>','500', '500' , '200' , '30')">
			   <?php echo  $dataList['cal_header'];// echo substr($dataList['cal_header'],0,30)?>... </a>
              <?php } else {  $day."-".$month."-".$year; ?>
            no activity
...
?>
       ...
       <br>
      <a href="?detail=ac-calendar" class="txt-white-blue-radius">คลิกดูปฏิทินกิจกรรมทั้งหมด</a><br><br><br><br></td>
    <td><IMG SRC="images/inside/nr_11.jpg" WIDTH=7 HEIGHT=193 ALT="" ></td>
  </tr>
  <tr align="left" valign="top"> 
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><table width="228" border="0" cellspacing="0" cellpadding="0">
      <tr>
  ...
  <tr align="left" valign="top"> 
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><img src="images/inside/nr_47.jpg" width=225 height=24 alt=""></td>
  </tr>
  <tr align="left" valign="top"> 
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><?php include("link_member.php"); ?></td>
  </tr>
  <tr>
  	<td colspan="3 "align="center" background="images/inside/nr_21.jpg"><?php include("../IRA-Contract.html"); ?></td>
  </tr>
<!--  <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><a href="../Career_ThaiNR.pdf" target="_blank"><img src="../images/career-thainr.gif" alt="career" width="200" height="250" border="0" /></a></td>
  </tr> -->
  <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><?php include("banner.php"); ?></td>
  </tr> <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><?php include("banner2.php"); ?></td>
  </tr>
  <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><?php include("knowledge.php"); ?></td>
  </tr>
  <tr align="left" valign="top">
  ...
  <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><p>	<!-- SiteSearch Google -->
...
<!-- SiteSearch Google --> </p></td>
  </tr>
  <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><table id="Table_01" width="223" height="108" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><img src="images/control/control_01.gif" width="18" height="43" alt="" /></td>
    <td><img src="images/control/control_02.gif" width="111" height="43" alt="" /></td>
    <td><img src="images/control/control_03.gif" width="94" height="43" alt="" /></td>
  </tr>
  <tr>
    <td><img src="images/control/control_04.gif" width="18" height="29" alt="" /></td>
    <td><a href="../control/" target="_blank"><img src="images/control/control_05.gif" alt="" width="111" height="29" border="0" /></a></td>
    <td><img src="images/control/control_06.gif" width="94" height="29" alt="" /></td>
  </tr>
  <tr>
    <td><img src="images/control/control_07.gif" width="18" height="22" alt="" /></td>
    <td><a href="http://mail.thainr.com/" target="_blank"><img src="images/control/control_08.gif" alt="" width="111" height="22" border="0" /></a></td>
    <td><img src="images/control/control_09.gif" width="94" height="22" alt="" /></td>
  </tr>
  <tr>
    <td><img src="images/control/control_10.gif" width="18" height="14" alt="" /></td>
    <td><img src="images/control/control_11.gif" width="111" height="14" alt="" /></td>
    <td><img src="images/control/control_12.gif" width="94" height="14" alt="" /></td>
  </tr>
</table></td>
  </tr>
  <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg">&nbsp;</td>
  </tr>
  <tr align="left" valign="top">
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"></td>
  </tr>
  <tr align="left" valign="top"> 
    <td colspan="3" align="center" background="images/inside/nr_21.jpg"><table width="225" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
...
<!--
  ...
  <tr align="left" valign="top" background="images/inside/nr_21.jpg"> 
    <td colspan="3"><img src="images/inside/nr_114.jpg" width="242" height="16" alt="" /></td>
  </tr>
</table>
<map name="Map" id="Map">
  <area shape="rect" coords="1,178,116,199" href="../IRA International Contract for Latex in Drum.pdf" target="_blank" />
  <area shape="rect" coords="118,200,198,219" href="../IRA International Contract for TSR.pdf" target="_blank" />
</map>
