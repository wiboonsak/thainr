...
box-shadow: 2px 2px 10px 2px #D4D4D4; -webkit-border-radius: 10px 10px 10px 10px; border-radius: 10px 10px 10px 10px;">
  <tr>
    <td height="35" align="left" bgcolor="#F5F5F5" style="font-family: 'Sarabun', sans-serif; font-size: 12pt; font-weight: 600;">&nbsp;&nbsp; สารจากนายกสมาคมยางพาราไทย      	
      </td>
  </tr>
  <tr>
...
<div align="left" class="style1">
  ...
  <tr>
    <td height="39" colspan="2" align="right" style="font-size:9pt">สารจากนายกสมาคมฯ เดือน<?php GetOnlyThaiMonth($speech['date_post'])?><?php if($speech['date_end']!='0000-00-00'){ echo "&nbsp&nbsp-&nbsp;";GetOnlyThaiMonth($speech['date_end']); } ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>
    </tr>
</table>
</center>
