...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="779">&nbsp;</td>
    <td width="150" align="right"><span class="txt8"><img src="../images/icon/30x30/002.png" width="30" height="30" alt="icon" style="vertical-align: text-bottom" /></span><a href="?detail=ac-meeting&amp;cateID=<?php echo $cateID?>">&#3585;&#3636;&#3592;&#3585;&#3619;&#3619;&#3617;ประชุม&#3607;&#3633;&#3657;&#3591;&#3627;&#3617;&#3604;</a>&nbsp;&nbsp;</td>
  </tr>
  <tr>
    <td height="40" colspan="3" align="left"><table width="100%" border="0" cellspacing="2" cellpadding="10">
      <tr>
        <td width="403" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="10">
 ...
 <?php mysql_data_seek($result,0); $n=1; while($data=mysql_fetch_assoc($result)){?>   
  <div class="contentdiv">
   <table width="100%" border="0" cellspacing="1" cellpadding="1">
          ...
          <tr>
            <td align="left" class="txt8"><img src="../images/icon/24X24/126.png" width="24" height="24" alt="icon" style="vertical-align: text-bottom" />&nbsp;<?php GetThaiDate($dateTitle[$n])?></td>
          </tr>
          <tr>
...
featuredcontentslider.init({
	...
	onChange: function(previndex, curindex, contentdivs){  //event handler fired whenever script changes slide
        ...
        <td valign="top">
         <table width="100%" border="0" cellspacing="0" cellpadding="5" style="padding-bottom: 5px; margin-bottom: 5px;">
          <?php for($i=2;$i<$nx;$i++){ ?>
          <tr>
