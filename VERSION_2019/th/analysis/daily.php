...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td width="35%" rowspan="3" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					<td height="25" colspan="3" align="center" bgcolor="#0099FF" class="text">
						<b>Daily Statistics For <?= date ("F"); ?></b>
					</td>
				</tr>
				<tr>
					<td width="20%" align="center" class="text" bgcolor="#999999" height="25"><b>Day</b></td>
				    <td width="40%" align="center" class="text" bgcolor="#999999" height="25"><b>Hits</b></td>
				    <td width="40%" align="center" class="text" bgcolor="#999999" height="25"><b>Visits</b></td>
				</tr>
				<?php
				...
				?>
				<tr align="center" <?php if (substr ($myrow['subdate'], 0, 2) == date ("d")) { echo "bgcolor=\"#FF6666\""; } else {echo "bgcolor=\"#CCCCCC\""; } ?>>
	    ...
	    <td width="65%" height="25" align="center" valign="middle" bgcolor="#0099FF" class="text">
			<b>
			<?php
		...
		<td width="65%" align="center" valign="top">
			...
			if (isset ($_REQUEST['type'])) {
				...
				if ($_REQUEST['type'] == 'hits') {
					...
					echo "<img src=\"gd_daily.php\" alt=\"Daily Hits\" width=\"525\" height=\"275\">";
					
				}
				
				if ($_REQUEST['type'] == 'visits') {
				
					echo "<img src=\"gd_daily_visits.php\" alt=\"Daily Visits\" width=\"525\" height=\"275\">";
