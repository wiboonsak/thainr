...
<center>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td align="left" background="images/inside/h-message_bg.gif"><img src="../images/h-title/h-calendar.jpg" alt="history" width="370" height="100"></td>
      ...
      <td width="782" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
          ...
          <tr>
			...
			<?php $n=1; while($file=mysql_fetch_assoc($resultFile)){ ?>
                        ...
                        <img src="../control/images/black_icon/16x16/download.png" width="16" height="16">&nbsp;&nbsp; <a href="../uploadfile/<?php echo $file['file_name']?>" target="_blank">ไฟล์ดาวโหลด <?php echo $n?></a><br>
<?php $n++; }?>
            &nbsp;&nbsp;			</td>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            ...
            <?php if($dateDiff > 0){ ?>
			<?php GetThaiDate($topicData['date_start']);?> &nbsp;-&nbsp; <?php GetThaiDate($topicData['date_end']);?>
            <?php }else{ GetThaiDate($topicData['date_start']);  } ?>
   			</td><td bgcolor="#F7F7F7">&nbsp;</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td height="60" align="center"><a href="#"  onClick="window.close();"><img src="images/close.gif" alt="close"  hspace="20" border="0"></a></td>
            <td>&nbsp;</td>
          </tr>
      </table></td>
