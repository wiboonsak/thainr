    ...
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="97" height="22" bgcolor="#FFFFFF">&nbsp;</td>
            <td width="1520" height="32" align="left" bgcolor="#FFFFFF" class="FontMS10"><img src="images/report-chart.gif" alt="chart" width="16" height="16" hspace="5"> <!--<a href="#" onClick="OpenNew('detail-stat.php?statID=<?php echo $stat['id']?>','750', '800' , '150' , '10')"></a> -->
...
-->	     <a href="http://www.thainr.com/uploadfile/<?php echo $stat['file_th']?>" target="_blank"><?php echo $stat['title_th']?></a>
          ...
          <tr>
            ...
            <td height="20" align="center" valign="bottom" bgcolor="#F8F8F8" class="FontMS10"><span class="cat_desc"> หน้า
