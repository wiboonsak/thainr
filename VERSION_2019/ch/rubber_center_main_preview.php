  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D7EFF9">
    ...
    <tr>
      <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table width="94%" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
          <tbody>
            <tr>
              <td width="183" valign="top"><form action="" name="formX">
              ...
              <td width="1454" height="450" valign="top"><div id="result" >&nbsp;</div></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
