    ...
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" bgcolor="#FFFFFF"><img src="../images/h-title/h-statistic.jpg" alt="history" width="341" height="80"></td>
          <td width="26" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="112" height="22" bgcolor="#FFFFFF">&nbsp;</td>
            <td width="1505" height="32" align="left" bgcolor="#FFFFFF" class="FontMS10">
              <img src="images/report-chart.gif" alt="chart" width="16" height="16" hspace="5">
              <!--<a href="#" onClick="windowOpener(850, 1000, 'windowName', 'detail-stat.php?statID=<?php //echo $stat['id']?>')"> -->
              <a href="http://www.thainr.com/uploadfile/<?php echo $stat['file_th']?>" target="_blank"><?php echo $stat['title_th']?></a><?php $icon="<img src=images/3_43.gif  hspace=3 />";  $day =$stat['date_post']; GetNewIcon($day,$icon)?>
            </td>
            <td width="51" height="22" align="right" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
          </tr><?php } ?>
          <tr>
            <td height="125" bgcolor="#FFFFFF">&nbsp;</td>
            <td align="left" bgcolor="#FFFFFF" class="FontMS10">&nbsp;</td>
            <td align="right" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
          <tr>
            <td bgcolor="#FFFFFF">&nbsp;</td>
            <td align="center" bgcolor="#F8F8F8" class="FontMS10"><span class="cat_desc">
              หน้า 
