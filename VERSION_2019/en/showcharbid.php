...
<?php
	$query ="SELECT * FROM  `tbl_rubber_bidding`    WHERE datex    =  '$StartDate'  AND language='1' AND id = '$id'  ";
...
while($data=mysql_fetch_assoc($resultData)){ 	
 ...
 //Create an XML data document in a string variable
   $strXML  = "";
   $strXML .= "<chart encoding='windows-874' caption='ราคาเสนอซื้อยาง'  xAxisName='$StartDate'  yAxisName='' showValues='0'    formatNumberScale='0' showBorder='1' >";
	for($i=1;$i<$n;$i++){   
