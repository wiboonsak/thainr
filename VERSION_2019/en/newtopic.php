...
<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" bgcolor="#D6EEFA" class="font11">
  <tr>
    <td colspan="2" align="center" nowrap><img src="images/inside/nr_73.jpg" width="496" height="116" alt="Webboard" /></td>
  </tr>
  <tr>
    <td height="10" colspan="2" nowrap bgcolor="#FFFFF5"></td>
  </tr>
 <tr>
    <td width="16%" height="44" align="right" nowrap bgcolor="fffff5" class="MS10-board"><span class="fonts">หมวดเว็บบอร์ด</span></td>
    <td width="84%" bgcolor="fffff5"><!--<select name="topic_type" id="topic_type">
      <option value="0">หมวดถามตอบยางพารา</option>
      <option value="1">หมวดซื้อขายยางพารา</option>
    </select>  -->
    <span class="txt-white-blue-radius"><input type="hidden" name="topic_type" value="<?php echo $_GET['selectCateBoard']?>">
    <?php if($_GET['selectCateBoard']==1){ ?>หมวดซื้อขายยางพารา<?php }else{ ?>หมวดถามตอบยางพารา<?php } ?></span>
    </td>
  </tr> 
  <tr>
    <td height="45" align="right" nowrap bgcolor="fffff5" class="MS10-board">หัวข้อกระทู้ </td>
    <td width="84%" bgcolor="fffff5"><input name="topic_th" type="text" class="input" id="topic_th" size="100" maxlength="100"></td>
  </tr>
  <tr>
    <td align="right" valign="top" bgcolor="fffff5" class="MS10-board"><span class="fonts">รายละเอียด</span></td>
