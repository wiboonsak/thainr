  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D7EFF9">
    ...
    <tr>
      <td align="center" valign="top" bgcolor="#FFFFFF"><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="40" align="left" bgcolor="#F5F5F5" style="font-family: 'Sarabun', sans-serif; font-size: 12pt; font-weight: 600;">&nbsp;&nbsp;TRA Calendar</td>
          </tr>
        </table>
...
$templates["calendar_section"] = "<!-- Calendar by www.pluggedout.com -->\n"
	...
	."		<td align='left'><span class='calendar_heading'><a class='calendar_link' href='<!--link_month_prev-->'><img src=images/arrow1.gif border=0></a></span></td>\n"
	."		<td align='center' ><b><span class='calendar_heading'><a class='calendar_link' href='<!--link_month_current-->'><!--month_name-->&nbsp;<!--year--></a></span></b></td>\n"
	."		<td align='right'><span class='calendar_heading'><a class='calendar_link' href='<!--link_month_next-->'><img src=images/arrow2.gif border=0></a></span></td>\n"
	."	</tr>"
...
?>
	 ...
	 if($type!='ListDate'){  /*
	  ?>
                    <tr>
                      <td width="24" align="center" class="text-news"><img src="images/inside/nr_42.jpg" width="24" height="21" alt="icon" /></td>
                      <td width="52" align="left" nowrap="nowrap" class="MS10-board">
					  <?php if($data['event_month']<10){ $data['event_month']="0".$data['event_month'];}  $dateX = $data['event_year']."-".$data['event_month']."-".$data['event_day'];?>
		...
		?>
                    <tr>
                      <td width="24" align="center" class="text-news"><img src="images/inside/nr_42.jpg" width="24" height="21" alt="icon" /></td>
                      <td width="52" align="left" nowrap="nowrap" class="MS10-board">
                        <?php  if($data['event_month']<10){ $data['event_month']="0".$data['event_month'];}  $dateX =$dataList['event_year']."-".$dataList['event_month']."-".$dataList['event_day'];?>
                        <?php GetThaiDate($dateX);?>					  </td>
                      <td width="606" align="left" class="text-news"><?php if($dataList['event_title']){?>
                        <a href="#" onClick="windowOpener(750, 1000, 'windowName', 'detail-calendar.php?keyID=<?php echo $dataList['event_id'];?>')"> <?php echo $dataList['event_title'];?></a><a href="#"  onclick="OpenNew('detail-calendar.php?keyID=<?php echo $dataList['id'];?>','500', '500' , '200' , '30')">...
                          <?php  $icon="<img src=\"images/3_43.gif\" alt=\"new\" width=\"21\" height=\"9\"  border=0/>";
				...
				$point ="x".$DATE[$i];
				 ...
				 ?>
                  <script language="javascript">
				 	document.getElementById('<?php echo $point?>').style.backgroundImage =   'url(./images/bg-top.jpg)'; 
				 </script>
                  <?php }
			 $oldDay = $DATE[$i];
			}
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td width="90%" height="30" align="left" bgcolor="#EEEEEE" class="h-catalog">
                        ...
                        <?php  echo $topic['minDay']."-".$topic['event_month']."-".$topic['event_year'];?>
                        to 
                        <?php  echo $topic['maxDay']."-".$topic['event_month']."-".$topic['event_year'];?>
                        <?php } ?>
