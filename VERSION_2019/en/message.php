...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td height="20" align="left" bgcolor="#F5F5F5" class="FontMS10 L25R7">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ <a href="message_detail.php?MID=<?php echo $message['id']?>" target="_blank" >Read more...</a>] &nbsp;</td>
                  </tr>
                  <tr>
