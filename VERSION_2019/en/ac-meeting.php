    ...
    <tr>
      <td width="100%" align="center" valign="top">
       <table width="95%" border="0" cellspacing="0" cellpadding="0" style="-webkit-box-shadow: 2px 2px 10px 2px #D4D4D4; box-shadow: 2px 2px 10px 2px #D4D4D4; -webkit-border-radius: 10px 10px 10px 10px; border-radius: 10px 10px 10px 10px;">
        <tr>
            <td align="left" height="40" bgcolor="#F5F5F5" style="font-family: 'Sarabun', sans-serif; font-size: 12pt; font-weight: 600;">&nbsp;&nbsp; Activites</td>
		</tr>
        <tr>
              ...
              <td width="841" align="right"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				...
				if($pic['file_name']==''){
                    ...
                    <tr>
                      ...
                      <td valign="bottom" class="txt8">Date <?php GetEngDate($data['date_act'])?></td>
                      <td>&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
       ...
       <p class="FontMS10">Page <?php  $thisFile=$thisFile."?detail=ac-meeting"; PageDisplay($queryNews,$rowPerPage,$_GET['page'],$thisFile)?><br>
      </p>
        <p>&nbsp;</p>
        <p></p>
      </td>
