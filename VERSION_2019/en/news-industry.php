<?php 
			...
			if((!$_GET['page'])||($_GET['page']==1)){
				  ...
				  if(!isset($xtype)){ $xtype=1;}else{ $xtype=$xtype;}
				  	...
				  	//$queryNews = "SELECT *  FROM `tbl_news`  WHERE c_type='2' AND c_lang='1'  ORDER BY c_update DESC   ";
					$queryNews = "SELECT *  FROM `tbl_news_data`  WHERE  cate_id ='2' AND language='$lang'   ORDER BY date_act DESC   ";
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D7EFF9">
    ...
    <tr>
      ...
      <td align="center" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="187"><img src="images/inside/nr_over_54.jpg" alt="ข่าวสาร" name="ข่าวสาร" width="187" height="35" border="0" id="ข่าวสาร" /></td>
