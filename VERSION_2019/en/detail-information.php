    ...
    <tr>
      ...
      <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
          ...
          <tr>
            ...
            <td height="13" bgcolor="#ebebeb"><strong>Source: </strong><?php echo $data['refference_data'];?></td>
            <td rowspan="2" bgcolor="#ebebeb">&nbsp;</td>
          </tr>
          <tr>
            <td height="17" bgcolor="#ebebeb">&nbsp;</td>
            <td height="17" bgcolor="#ebebeb"><strong>Date: </strong>
				<?php if($lang='1'){ echo GetThaiDate($data['date_add']); }else{ echo GetEngDate($data['date_add']);} ?>
			</td>
          </tr>
          <tr>
            <td bgcolor="#ebebeb">&nbsp;</td>
            <td height="60" align="center" bgcolor="#ebebeb"><a href="#"  onClick="window.close();"><img src="../images/h-title-2019/close-botton.png" alt="close" width="165" height="38" hspace="20" border="0"></a></td>
            <td bgcolor="#ebebeb">&nbsp;</td>
          </tr>
      </table></td>
