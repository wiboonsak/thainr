<?php 
			...
			if((!$_GET['page'])||($_GET['page']==1)){
					...
					$startRow=($_GET['page']-1)*$rowPerPage;
				  	...
				  	$queryNews = "SELECT *  FROM `tbl_news_data`  WHERE  cate_id ='3' AND language='$lang'   ORDER BY date_act DESC   ";
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D7EFF9">
    ...
    <tr>
      ...
      <td align="center" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td width="145"><img src="images/inside/nr_over_53.jpg" alt="ข่าวสาร" name="ข่าวสาร" width="145" height="35" border="0" id="ข่าวสาร" /></td>
