        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
          ...
          array_push($arrayName,str_replace('บริษัท','',$data['name']));
                ...
                <tr height="19">
                  ...
                  <td height="28" align="left"><a href="http://thainr.com/VERSION_2019/en/detail_member/member_dataen.php?&IDS=<?php echo $data['id']?>"  target="_blank"><?php echo $data['name']?>&nbsp;</a></td>
                </tr>
                <?php $a++;} ?>
              </tbody>
            </table></td>
