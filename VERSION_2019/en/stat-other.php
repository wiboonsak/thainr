<?php
		...
		$queryMessage="SELECT *  FROM `tbl_rubber_statistic`   WHERE statistic_type ='other'     ORDER BY  date_post DESC   ";
    ...
    <tr>
      <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" bgcolor="#FFFFFF"><img src="../images/h-title/h-statistic-other.jpg" alt="history" width="341" height="80" /></td>
          <td width="26" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
        </table>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="98" height="32" bgcolor="#FFFFFF">&nbsp;</td>
            <td width="1649" height="32" align="left" bgcolor="#FFFFFF" class="FontMS10 bottom-dot"><img src="../th/images/report-chart.gif" alt="chart" width="16" height="16">
              <!--<a href="#" onClick="OpenNew('detail-stat.php?statID=<?php echo $stat['id']?>','750', '800' , '150' , '10')"></a> -->
              <!--<a href="#" onClick="windowOpener(750, 1000, 'windowName', 'detail-stat.php?statID=<?php //echo $stat['id']?>')">--><a href="http://www.thainr.com/uploadfile/<?php echo $stat['file_th']?>" target="_blank"><?php echo $stat['title_en']?></a>
              <?php $icon="<img src=../th/images/3_43.gif  hspace=3 />";  $day =$stat['date_post']; GetNewIcon($day,$icon)?></td>
            <td width="54" height="22" align="right" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
          </tr>
          <?php } ?>
          <tr>
            <td height="195" bgcolor="#FFFFFF">&nbsp;</td>
