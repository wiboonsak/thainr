...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="803">&nbsp;</td>
    <td width="267" align="right"><img src="images/inside/nr_42.jpg" alt="icon" width="24" height="21" style="vertical-align: text-bottom"/><a href="?detail=news-industry">&#3586;&#3656;&#3634;&#3623;อุตสาหกรรมยานยต์&#3607;&#3633;&#3657;&#3591;&#3627;&#3617;&#3604;</a></td>
  </tr>
  ...
  <tr>
    ...
    <td><!--<a href="#"  onclick="OpenNew('detail-news.php?ActID=<?php echo $data['c_id']?>','600', '700' , '200' , '10')"> --> <a href="#" onclick="windowOpener(700, 1000, 'windowName', 'detail-news.php?ActID=<?php echo $data['id']?>')">
