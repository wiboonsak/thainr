...
include("config.inc.php");
		...
		$query="SELECT * FROM tbl_rubber_price  WHERE date_update BETWEEN '2007-10-01' AND '2007-10-31' "
...
$chart[ 'axis_category' ] = array (  'size'=>14, 'color'=>"#FF0000", 'alpha'=>90, 'skip'=>0 ,'orientation'=>"horizontal" ); 

$chart[ 'axis_ticks' ] = array ( 'value_ticks'=>false, 'category_ticks'=>true, 'major_thickness'=>2, 'minor_thickness'=>1, 'minor_count'=>1, 'major_color'=>"000000", 'minor_color'=>"222222" ,'position'=>"inside" );

$chart[ 'axis_value' ] = array ( 'min'=>0, 'size'=>14, 'color'=>"000000", 'alpha'=>90, 'steps'=>6, 'prefix'=>"", 'suffix'=>"", 'decimals'=>0, 'separator'=>"", 'show_min'=>false );
