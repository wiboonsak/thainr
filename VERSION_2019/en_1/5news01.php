<?php
	//$query="SELECT  *  FROM `tbl_news`  WHERE c_type='1'  AND c_lang='2'  ORDER BY  c_update DESC  LIMIT 0 , 5 ";
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="779">&nbsp;</td>
    <td width="150" align="right"><span class="txt8"><img src="../images/icon/30x30/002.png" width="30" height="30" alt="icon" style="vertical-align: text-bottom" /></span><a href="?detail=news-rubber&xtype=1">All Rubber News</a></td>
  </tr>
