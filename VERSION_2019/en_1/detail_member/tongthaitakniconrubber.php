...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong><A href="http://www.tongthairubber.com" target="_blank">TONGTHAI TECHNICAL RUBBER CO.,LTD. ด</A></strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p align="left">984/52 Klongtan Trade Centre,Sukhumvit 71,Klongtonnua, Wattana, Bangkok 10110</p></td>
        </tr>
        <tr>
          <td height="25" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">(02)   3902051-3, 7132051-2</p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="25"></td>
          <td ><p align="left">(02)   3811395, 7132050</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></td>
          <td height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><A href="mailto:tongthai@bkk3.loxinfo.co.th">tongthai@bkk3.loxinfo.co.th</A>, <A href="mailto:ttinter@lox2.loxinfo.co.th">ttinter@lox2.loxinfo.co.th</A></p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Website </strong></p></td>
          <td height="25"></td>
          <td ><p align="left"><a href="http://www.tongthairubber.com" target="_blank">www.tongthairubber.com</a></p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td ><p align="left">Mr.Seree Sirisuwat </p></td>
        </tr>
        <tr>
          <td height="25"><p align="right">&nbsp;</p></td>
          <td height="25"></td>
          <td ><p align="left">Mr.Tawat Sirisuwat </p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          <td height="30" valign="top"><p align="right"><strong>Products/Capacity </strong></p></td>
