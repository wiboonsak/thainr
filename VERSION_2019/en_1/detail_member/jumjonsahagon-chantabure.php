...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>RUBBER HOLDER CO-OPERATIVES FEDERATION OF CHANTHABURI LIMITED (RCFC&amp;KYM) </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td width="10" height="25"></td>
          <td ><p align="left">Mr.Perk Lerdwangpong </p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td height="25"></td>
          <td><p>Mr. Chinji Kuyama - Tel.   (02) 5652559,Fax. (02) 5652569</p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td valign="middle"><p align="left">RSS   1-3 (1,100 MT/Month) </p></td>
        </tr>
        <tr>
