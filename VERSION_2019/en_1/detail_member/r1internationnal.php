...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>R1 INTERNATIONAL (THAILAND) LTD. </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td>66-68-70 Nipat Uthit 1 Road,  Hatyai, Songkhla 90110 </td>
        </tr>
        <tr>
          <td height="25" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">(074)   231457, 231533</p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="25"></td>
          <td ><p align="left">(074)   233007</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><A href="mailto:surin@r1international.com">leslie@r1international.com</A></p></td>
        </tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p>Mr.Leslie Cheng (Manager) </p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td height="19"></td>
          <td valign="middle"><p align="left">Natural Rubber </p></td>
        </tr>
        <tr>
