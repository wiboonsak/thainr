...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>THAI MAC STR CO.,LTD. </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          <td height="25" align="right" bgcolor="#EAEAEA"><strong>Email</strong></td>
          <td height="25" bgcolor="#EAEAEA"></td>
          <td align="left" bgcolor="#EAEAEA"><a href="mailto:tm.mkt@thaimac.co.th">tm.mkt@thaimac.co.th</a></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td><p>Mr. Kran Kittipol (Manager)</p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td height="23"></td>
          <td valign="middle"><p align="left">Latex (4,000 MT/Month)<br>
		  RSS (5,000 MT/Month)<br>
		  STR 10, 20 (6,000 MT/Month)
		  </p></td>
        </tr>
        <tr>
