...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong> RUBBER HOLDER CO-OPERATIVES FEDERATION OF THAILAND LIMITED (RCFT) </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
          ...
          <TR>
            ...
            <TD height="25"></TD>
            <TD><p align="left">17/1 Kanchanavanich Rd., Tambon Banphru, Hatyai, Songkhla 90250</p></TD>
          </TR>
          <TR>
            <TD height="25" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></TD>
            <TD width="10" height="25" bgcolor="#EAEAEA"></TD>
            <TD  bgcolor="#EAEAEA"><p align="left">(074) 439920-1 , 439905-6</p></TD>
          </TR>
          <TR>
            <TD height="25"><p align="right"><strong>Fax </strong></p></TD>
            <TD width="10" height="25"></TD>
            <TD ><p align="left">(074)   217302</p></TD>
          </TR>
          <TR>
            <TD height="25" vAlign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></TD>
            <TD width="10" height="25" bgcolor="#EAEAEA"></TD>
            <TD  bgcolor="#EAEAEA"><p align="left"><A href="mailto:rcfc@chaiyo.com">rcfc@chaiyo.com</A><A href="mailto:clitex@loxinfo.co.th"></A> <A href="mailto:tts@hadsyn.co.th"></A></p></TD>
          </TR>
          <TR>
          ...
          <TR>
            ...
            <TD width="10" height="25"></TD>
            <TD ><p align="left">Mr. Perk Lertwangpong </p></TD>
          </TR>
          <TR>
            <TD height="25" colspan="3"><hr width="100%"></TD>
          </TR>
          <TR>
            <TD height="35" valign="top"><p align="right"><strong>Products/Capacity </strong></p></TD>
            <TD width="10" height="35"></TD>
            <TD valign="middle"><p align="left">RSS, ADS, Field Latex, Crape </p>            </TD>
          </TR>
          <TR>
