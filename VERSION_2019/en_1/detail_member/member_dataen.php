...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10" style="text-transform: uppercase !important"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong><?php echo $data['name']?></strong></span></td>
