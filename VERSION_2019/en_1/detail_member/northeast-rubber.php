...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>NORTH EAST RUBBER </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          <td width="150" height="25"><div align="right"><strong>Company</strong></div></td>
          <td height="25"></td>
          <td>398 Moo 4 Tambol Kokma, Prakonchai District, Buriram 31140 </td>
        </tr>
        <tr>
          <td height="25" bgcolor="#EAEAEA"><p align="right"><strong>Telephone</strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">(044) 666928, 666929</p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Fax.</strong></p></td>
          <td width="10" height="25"></td>
          <td ><p align="left">(044) 666212, 666213</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail</strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><A href="mailto:nerubber@hotmail.com">nerubber@hotmail.com</A></p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td ><p align="left">Mr. Chuwit Jungtanasomboon</p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td height="25"></td>
          <td><p>Mr. Chuwit Jungtanasomboon</p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          <td height="19" valign="top"><p align="right"><strong>Product/Capacity</strong></p></td>
          <td height="19"></td>
          <td valign="middle"><p align="left">SRR (2,400   เมตริกตัน/เดือน)</p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
