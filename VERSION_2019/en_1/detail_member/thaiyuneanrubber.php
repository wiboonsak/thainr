...
<center>
  ...
  <table width="95%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><span class="FontMS10"><img src="../../th/images/icon_www2.gif" alt="icon" width="15" height="14" hspace="5"><strong>THAI UNION RUBBER CO.,LTD. </strong></span></td>
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF"><table width="80%" align="center" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td height="25"></td>
          <td>59 Plenpitak Road,Muang,Trang 92000 </td>
        </tr>
        <tr>
          <td height="25" bgcolor="#EAEAEA"><p align="right"><strong>Telephone </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left">(075)   218098 (8 line)</p></td>
        </tr>
        <tr>
          <td height="25"><p align="right"><strong>Fax </strong></p></td>
          <td width="10" height="25"></td>
          <td ><p align="left">(075)   210374</p></td>
        </tr>
        <tr>
          <td height="25" valign="center" bgcolor="#EAEAEA"><p align="right"><strong>E-Mail </strong></p></td>
          <td width="10" height="25" bgcolor="#EAEAEA"></td>
          <td  bgcolor="#EAEAEA"><p align="left"><A href="mailto:wisantur@taksin.co.th">wisantur@taksin.co.th</A><a href="mailto:trc@loxinfo.co.th"></a></p></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="25"></td>
          <td ><p align="left">Mr.Sombat Tanti-Apichart <br>
            Mr.Wisan Rattanaekkawin </p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td height="25"></td>
          <td><p>Mr.Wisan Rattanaekkawin </p></td>
        </tr>
        <tr>
          <td height="25" colspan="3"><hr width="100%"></td>
        </tr>
        <tr>
          ...
          <td height="19"></td>
          <td valign="middle"><p align="left">RSS (1,800   MT/Month)</p></td>
        </tr>
        <tr>
