<?php
	//$query="SELECT  *  FROM `tbl_news`  WHERE c_type='3'  AND c_lang='2'  ORDER BY  c_update DESC  LIMIT 0 , 5 ";
	//$result =mysql_query($query);
	$query="SELECT  *  FROM `tbl_news_data`  WHERE cate_id ='3' AND language='$lang' ORDER BY  date_act  DESC  LIMIT 0 , 5 ";
	$result =mysql_query($query);
?>
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="840">&nbsp;</td>
    <td width="216" align="right"><span class="txt8"><img src="../images/icon/30x30/002.png" width="30" height="30" alt="icon" style="vertical-align: text-bottom" /></span><a href="?detail=news-economic">All World Economic News</a></td>
  </tr>
  ...
  <tr>
	...
	<?php echo strip_tags($data['topic_th'],'<*>');?></a>&nbsp;<?php  $icon="<img src=\"../th/images/3_43.gif\" alt=\"new\" width=\"21\" height=\"9\" />";
