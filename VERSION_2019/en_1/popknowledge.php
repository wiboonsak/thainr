...
<body><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
  <tr>
    <td colspan="2" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" background="../images/h-title/h-message_bg.gif"><img src="../images/h-title/h-knowledge.jpg" alt="history" width="370" height="100" /></td>
  ...
  <tr>
    ...
    <td width="92%" class="FontMs12">&nbsp;<strong><?php echo $data['title_th']?> &nbsp;&nbsp; <?php  $icon="<img src=\"../th/images/3_43.gif\" alt=\"new\" width=\"21\" height=\"9\" />";
			 GetNewIcon($data['date_post'],$icon)?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td  ><embed src=" http://www.thainr.com/uploadfile/<?php echo $data['file_th']?>" type="application/pdf" width="100%" height="700px" /></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td class="Saan">
	...
	File download <img src="../th/images/download2.gif" width="32" height="32" border="0" align="absbottom" /></a>
	<?php } ?>	</td>
  </tr>
   <tr>
    <td colspan="2" align="right" class="Saan"><hr size="1" color="#E8E8E8" /></td>
