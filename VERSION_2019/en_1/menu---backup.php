	  ...
	  ?>
        ...
        <tr>
          ...
          <td align="left" class="text-news"><?php if($dataList['cal_header']){?>
            ...
            no activity
            <?php }?>
            <a href="#" onclick="if(confirm('ต้องการลบหัวข้อนี้ ?')){ form1.action.value='delete';form1.delID.value='<?php echo $dataList['id']?>';form1.submit()}else{ return false;}"></a></td>
        </tr>
        <tr>
          <td height="1" colspan="4" bgcolor="#E6E6E6"></td>
        </tr>
          ...
          <table width="223" border="0" bgcolor="#ffffff">
            ...
            <tr>
              <td align="center" nowrap="nowrap"><table>
                  ...
                  <input type="submit" name="sa" value="ค้นหา" id="sbb" />
                </input>
