...
<table width="99%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr class="red">
    ...
    <td width="96%" bgcolor="#D9D9B3">รายชื่อข่าวสาร

    
      <select name="cate_id" id="cate_id" onchange="document.form1.submit()">
        <option value="0">---- <?php echo _txtSelectCagegory?>----</option>
        <option value="1" <?php if($_POST['cate_id']=='1') echo "selected";?>><?php echo _txtRubberNews?></option>
        <option value="2" <?php if($_POST['cate_id']=='2') echo "selected";?>><?php echo _txtAutomobileNews?></option>
          <option value="3" <?php if($_POST['cate_id']=='3') echo "selected";?>><?php echo _txtEconomicNews?></option>      
    </select>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="txt10-black">
      ...
      <tr>
        ...
        <td align="center" bgcolor="#EFEFEF"><a href="main.php?work=NewsAdd&currID=<?PHP echo $data['id']?>"><img src="images/black_icon/16x16/doc_edit.png" width="16" height="16" style="border:none" /></a></td>
