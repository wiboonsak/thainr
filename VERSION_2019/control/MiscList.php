<?php 
	...
	if($_POST['action']=='Delete'){
			 $query="SELECT * FROM `tbl_misc_data` WHERE  `id` =  '".$_POST['IDS']."' ";
			 //echo $query."<br>";
			...
			$query="DELETE FROM `tbl_misc_data`  WHERE  `id` =  '".$_POST['IDS']."' ";
			mysql_query($query);	
			// echo $query."<br>";		 
		}
	...
	####################################################	
				...
				$query="SELECT * FROM   `tbl_misc_data` WHERE  language= '".$_SESSION['language']."'  ORDER BY id DESC";
...
<table width="99%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr class="red">
    ...
    <td width="96%" bgcolor="#D9D9B3">รายชื่อระบบเก็บมาฝาก
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="2" class="txt10-black">
      ...
      <tr>
        ...
        <td align="center" bgcolor="#EFEFEF"><a href="main.php?work=MiscAdd&currID=<?PHP echo $data['id']?>"><img src="images/black_icon/16x16/doc_edit.png" width="16" height="16" style="border:none" /></a></td>
