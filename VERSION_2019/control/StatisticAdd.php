<?php 
	...
	if($_POST['action']=='Add'){
				...
				if($_POST['currID']==''){ 	
					...
					$query="INSERT INTO `tbl_rubber_statistic` (`id` ,`title_th` ,`title_en` ,`detail_th` ,`detail_en` ,`file_th` ,`file_en` ,`statistic_type` ,  `date_post`  ) "
					." VALUES  "
					." ( '' , '".$_POST['title_th']."', '".$_POST['title_en']."', '".$_POST['detail_th']."', '".$_POST['detail_en']."', '".$_FILES['uploadfile']['name']."', '".$_FILES['uploadfile']['name']."', '".$StatType."' , '".$_POST['date_act']."' ) ";
					mysql_query($query);
					$_POST['currID']=mysql_insert_id();
							...
							//------------------------------------		
							$query="UPDATE tbl_rubber_statistic SET  `title_th`='".$_POST['title_th']."'  ,`title_en`= '".$_POST['title_en']."'  ,`detail_th`='".$_POST['detail_th']."' ,`detail_en`='".$_POST['detail_en']."'   "
	...
	####################################################	
    if($_POST['currID']){
					$query="SELECT * FROM tbl_rubber_statistic WHERE id = '".$_POST['currID']."' ";
...
<table width="99%" border="0" align="center" cellpadding="2" cellspacing="2">
  <tr class="red">
    ...
    <td width="96%" bgcolor="#D9D9B3"><?php echo $txttopic?>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellpadding="2" cellspacing="2" class="txt10-black">
      <tr>
        <td width="11%" align="right"><strong>หัวข้อ</strong></td>
        <td width="89%"><input name="title_th" type="text" id="title_th" size="40" maxlength="255"  value="<?php echo $currentData['title_th']?>"/></td>
      </tr>
      <tr>
     ...
     <tr>
      ...
      <tr>
        <td align="right"><strong>ไฟล์ PDF</strong></td>
        <td>
...
<?php }?>
      ...
      <tr>
        <td><strong>
          ...
          <input name="oldFileName" type="hidden" id="oldFileName" value="<?php echo $currentData['file_th']?>" />
        </strong></td>
        <td><input type="submit" name="button" id="button" value="เพิ่ม / แก้ไข ข้อมูล" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
