			...
			$_POST['date_act']=$_POST['syear']."-".$_POST['smonth']."-".$_POST['sdate'];
					if($_POST['currID']==''){
						 ...
						 $query="INSERT INTO `tbl_news_and_act` "
										    ." ( `id` , `topic_th` , `topic_en` , `detail_th` , `detail_en` , `date_act`, `cate_id` , `language` ) "
											." VALUES "
											." ('' , '".$_POST['topic_th']."', '".$_POST['topic_en']."', '".$_POST['detail_th']."', '".$_POST['detail_en']."',  '".$_POST['date_act']."' ,  '".$_POST['cate_id']."' ,  '".$_SESSION['language']."') ";
								mysql_query($query);
