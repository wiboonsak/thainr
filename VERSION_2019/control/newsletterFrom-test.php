...
//---------------------------------------------------------------------------------------------------------------------------------------------------
	...
	//." LEFT JOIN tbl_thainr_member b ON a.memberID=b.id  WHERE a.keyGroup='".$_SESSION['KEY_GROUP']."' ORDER BY a. 	memberID DESC ";
				...
				$query="SELECT   name,  id AS memID  FROM tbl_thainr_member  LIMIT 0, 30 ";
    ...
    <td align='left' valign='top'>&nbsp;</td>
				...
				if(!$mail->Send()) 
				{
				   ...
				   exit;
						...
						echo "MAIL SEND->".$email['email']." >>".$email['name']."<br>";
					}
    ...
    <td colspan="2" class="txt10-black">
    		...
    		<table border="0" cellspacing="1" cellpadding="1">
                  ...
                  <?php $n=1;$col=3; while($data=mysql_fetch_assoc($result)){ ?>
                    ...
                    <td width="177" height="25" nowrap="nowrap" bgcolor="#EBEBEB"><?php echo htmlspecialchars($data['name'])?></td>
