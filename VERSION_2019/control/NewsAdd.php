  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellpadding="2" cellspacing="2" class="txt10-black">
      ...
      <tr>
        ...
        <td>
			<!--<input name="topic_th" type="text" id="topic_th" size="60" maxlength="255"  value="<?php //echo $currentData['topic_th']?>"/>-->
			
		  <textarea  name="topic_th" id="topic_th"  style="width: 700px;" rows="3"><?php echo $currentData['topic_th']?></textarea>
		  </td>
      </tr>
      <tr>
