    ...
    <tr>
      <td colspan="4" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td align="left" background="../images/h-title/h-message_bg.gif"><img src="../images/h-title/h-activities.jpg" alt="history" width="354" height="100" /></td>
    ...
    <tr>
      ...
      <td valign="top" bgcolor="#EBEBEB"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
        ...
        <tr>
          ...
          <td align="left" bgcolor="#FFFFFF"><strong><?php echo $data['topic_ch']?></strong> &nbsp;
        ...
        <tr>
          <td height="85">&nbsp;</td>
          <td align="left"><br>            <?php echo $data['detail_ch']?></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
