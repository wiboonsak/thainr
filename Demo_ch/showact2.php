...
$thb2path="../uploadfile/";
 $nx=1;  while($data=mysql_fetch_assoc($result)){
				...
				if($nx==1){
					...
					$data['detail_th']= strip_tags($data['detail_ch'],'<*>');
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="779" height="30">&nbsp;</td>
    <td width="150" height="30" align="right"><span class="txt8"><img src="../images/icon/30x30/002.png" width="30" height="30" alt="icon" style="vertical-align: text-bottom" /></span><a href="?detail=ac-special&cateID=<?php echo $cateID?>">All Other Activities</a>&nbsp;</td>
  </tr>
  <tr>
