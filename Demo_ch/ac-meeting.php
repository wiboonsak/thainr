<?php
	...
	//$queryNews="SELECT  *  FROM `tbl_news_and_act`  WHERE cate_id = '2' AND language='$lang'   ORDER BY  date_act DESC ";
	$queryNews="SELECT  *  FROM `tbl_news_and_act`  WHERE cate_id = '2'  AND language = '3'  ORDER BY  date_act DESC ";	
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D7EFF9">
    ...
    <tr>
      ...
      <td align="center" valign="top"><table width="95%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="161"><img src="../th/images/inside/nr-en-over_29.jpg" alt="TRA MEETING"  border="0" ></td>
            ...
            <tr>
              ...
              <td width="943" align="left"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
                ...
                <tr>
                  ...
                  <td align="left" valign="bottom" class="txt8">Date&nbsp;<?php GetEngDate($data['date_act'])?>
                    </td>
                  <td width="594" align= align="left" valign="top" style="padding-top:5px; padding-bottom:5px; padding-left:10px; padding-right:5px;">&nbsp;</td>
                  <td align="center">&nbsp;</td>
                </tr>
                <tr>
                  <td height="108" align="center">&nbsp;</td>
                  <td width="142"><a href="#" onClick="windowOpener(700, 750, 'windowName', 'detail-activity.php?ActID=<?php echo $data['id']?>')"> <img src="<?php echo $pic['file_name']?>" alt="" width="125" height="90" style="vertical-align:middle; border:none;" class="radius5" /></a></td>
                  <td style="padding-top:5px; padding-bottom:5px; padding-left:10px; padding-right:5px;" align= align="left" valign="top"><img src="../images/icon/24X24/105.png" alt="webboard" width="24" height="24" style="vertical-align:text-bottom"><a href="#"  id="news" onClick="windowOpener(700, 1000, 'windowName', 'detail-activity.php?ActID=<?php echo $data['id']?>')"><strong><?php echo $data['topic_ch'];?></strong></a>
                    <?php if(($n==1)&&($page==1)){ ?>
                    <img src="../th/images/3_43.gif" alt="new" width="21" height="9" />
                    <?php } ?><br><br>
				 <?php 
						  $data['detail_en']=strip_tags($data['detail_ch']);
						  $data['detail_en']=iconv_substr($data['detail_ch'] ,0 , 200, "UTF-8")."..";
						  echo $data['detail_ch'];
						 ?>
</td>
                  <td align="center">&nbsp;</td>
        ...
        <p class="FontMS10">Page: 
          <?php  $thisFile=$thisFile."?detail=ac-meeting"; PageDisplay($queryNews,$rowPerPage,$page,$thisFile)?>
<br>
        </p>
        <p>&nbsp;</p>
