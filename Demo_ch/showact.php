...
$thb2path="../uploadfile/";
 $nx=1;  while($data=mysql_fetch_assoc($result)){
	  			$query="SELECT * FROM tbl_news_and_act_file WHERE news_id ='".$data['id']."' AND file_type='1' ORDER BY picSort ASC , id ASC LIMIT 0,1 ";
				...
				if($nx==1){
							if($pic['file_name']==''){
									 ...
									 //if(!file_exists($thb2path.$pic['file_name'])){ 
							...
							if($pic['file_name']==''){
										...
										//list($width, $height, $type, $attr) = getimagesize("../uploadfile/".$pic['file_name']);
										//create_thub($thb2path ,$pic['file_name'],$n_width,$n_height);
										//$pic['file_name']=$thb2path.$pic['file_name'];
											list($width, $height, $type, $attr) = getimagesize("../uploadfile/".$pic['file_name']);
										create_thub2($thb2path ,$pic['file_name'],$n_width,$n_height);
										$pic['file_name']=$thb2path."tmp/".$pic['file_name'];
								}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="FontMS10">
  <tr>
    ...
    <td width="758" height="30">&nbsp;</td>
    <td width="283" height="30" align="right"><span class="txt8"><img src="../images/icon/30x30/002.png" width="30" height="30" alt="icon" style="vertical-align: text-bottom" /></span><a href="?detail=ac-meeting&amp;cateID=<?php echo $cateID?>">All Meeting Activities</a>&nbsp;&nbsp;</td>
  </tr>
  <tr>
...
featuredcontentslider.init({
	...
	onChange: function(previndex, curindex, contentdivs){  //event handler fired whenever script changes slide
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="5">
          <?php for($i=2;$i<$nx;$i++){ ?>
          <tr>
            <td width="126" align="center" bgcolor="#F3F3F3"><img src="<?php echo $PicTitle[$i]?>" width="125" height="90" class="radius5" style="vertical-align:middle; border:none;" /></td>
